...
namespace Tuan4_NguyenXuanTam.Controllers
{
    public class SachController : Controller
    {
        ...
        {
            var listTheLoai = from ss in data.TheLoais select ss;
        ...
        public ActionResult Create(FormCollection collection, Sach s)
        {
            ...
            var E_maloai = collection["Category"];
        ...
        public ActionResult Edit(int id)
        {
            ...
            var listTheLoai = from ss in data.TheLoais select ss;
            var edit = data.Saches.Where(p => p.masach == id).First();
            ViewBag.ListTheLoai = listTheLoai;
            return View(edit);
        }
        [HttpPost]
